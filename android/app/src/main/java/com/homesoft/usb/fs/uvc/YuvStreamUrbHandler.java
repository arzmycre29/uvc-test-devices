...
public final class YuvStreamUrbHandler extends VideoUrbHandler implements IFrameCallback {
    ...
    public final int imgFormat;

    public YuvStreamUrbHandler(FormatDesc formatDesc, FrameDesc frameDesc, int endpointAddress, int maxPacketSize, int packetsPerUrb, int interval, int maxPayloadTransferSize, int maxVideoFrameSize, int imgFormat) {
    ...
    public synchronized boolean start() throws Throwable {
        ...
        Log.d(TAG, "yuvStreamHandler started: ep=" + this.endpointAddress + ", pktSize=" + packetSize + ", pkts=" + this.packetsPerUrb + ", frameSize=" + frameSize + " -> handle=" + this.r);
